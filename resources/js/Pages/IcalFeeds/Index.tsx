        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center justify-between">
                    ...
                    >
                        {showCreateForm ? 'Cancel' : 'New Feed'}
                    </button>
                </div>
            }
        >
                ...
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 rounded-lg bg-blue-50 p-4">
                        <div className="flex">
                            ...
                            <div className="ml-3">
                                <h3 className="text-sm font-medium text-blue-800">About iCal Feeds</h3>
                                ...
                                <div className="inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
                                            ...
                                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                ...
                                                <div className="mt-4">
                                                    ...
                                                    <button
                                                        ...
                                                        className="mt-3 w-full rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500"
                                                    >
                                    ...
                                    <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                        <button
                                            ...
                                            className="inline-flex w-full justify-center rounded-md border border-transparent bg-gray-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm"
                                        >
                                            Close
                                        </button>
                                    </div>
